...
function WakeupGenie() {
    ...
    var buf ='<input id="orderGenie" type="button" onclick=pasteTo("genie") value=" " style="width:3%; padding-left:0px; background-color:#d0d0ff"></input><input id="genie" style="width:97%; background-color:#e0e0ff"></input>';
    el.innerHTML = buf;
